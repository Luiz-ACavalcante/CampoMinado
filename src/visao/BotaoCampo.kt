...
private val COR_BG_EXPLOSAO = Color(255, 0, 43)
private val COR_BG_VERDE = Color(0, 255, 0)
...
class BotaoCampo(private val campo: Campo) : JButton() {
    init {
        ...
        addMouseListener(MouseCliqueListener(campo, { it.abrir() }, { it.alterarMarcado() }))
    ...
    private fun aplicarEstiloAberto() {
        ...
        foreground = when (campo.QtdeVizinhosMinado) {
            1 -> COR_BG_VERDE
            2 -> Color.BLUE
            3 -> Color.YELLOW
            4, 5, 6 -> Color.RED
        ...
        text = if (campo.QtdeVizinhosMinado > 0) campo.QtdeVizinhosMinado.toString() else " "
    }
